...
items=submission.items # NOTE variable was mentioned in the assignment 2 spec
inventory_limit = 3 # NOTE variable was mentioned in the assignment 2 spec
...
class Odie(object):
    def __init__(self, alpha=submission.ALPHA, gamma=submission.GAMMA, n=submission.N, epsilon=submission.EPSILON):
    ...
    def update_q_table(self, tau, S, A, R, T):
        ...
        # BEGIN MINE
        # if self.q_table[()]["red_mushroom"] != 0.0:
        #     for item, actions in self.q_table.items():
        #         print(item, actions)
        # elif self.q_table[()]["pumpkin"] != 0.0:
        #     for item, actions in self.q_table.items():
        #         print(item, actions)
        # print(self.n)
        # print("curr_s and curr_a:", curr_s, curr_a)
        # for item, actions in self.q_table.items():
        #         print(item, actions)
        # END MINE
...
if __name__ == '__main__':
    ...
    # n=1
    # odie = Odie(n=n)
    odie = Odie() # NOTE: I MODIFIED THIS
    # BC WHY TF DID THEY HAVE N HERE OVERWRITING THE DEFAULT VALUE OF THE CONSTRUCTOR?????
    # BUT GAMMA AND ALPHA ARE ONLY IN THE CONSTRUCTOR?????
    # print("n=",n)
    ...
    for iRepeat in range(num_reps):
        ...
        if (iRepeat + 1) % 5 == 0:
            ...
            if found_solution:
                ...
                print('Done')
                time.sleep(10) # NOTE I added this line so taking a screenshot for Q5 would be easier
                break
        else:
